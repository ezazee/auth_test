                ...
                <ul className="pb-2 space-y-2">
                  ...
                  <li>
                    ...
                    <ul
                      ...
                      className="space-y-2 py-2 hidden "
                    >
                      <li>
                        <a
                  ...
                  <form className="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
                    <article className="mb-5">
                      ...
                      <p className="mb-2 text-gray-900 dark:text-white">
                        ...
                        week. It would be great to gather everyone involved in
                        the design project. Let me know about your availability
                        in the thread.
                      </p>
                    ...
                    <article className="pl-12 mb-5">
                      ...
                      <p className="mb-4 text-gray-900 dark:text-white">
                        ...
                        Sure, just let me know whean you are available and we
                        can speak.
                      </p>
                    ...
                    <div className="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
                      ...
                      >
                        ...
                        <ul className="pl-4 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400">
                          ...
                          <li>
                            How the online delivery business model is
                            diversifying to meet new demands.
                          </li>
                          <li>
                          ...
                          <li>
                            How a headless commerce architecture solves
                      ...
                      >
                        ...
                        >
                          ...
                          <li className="flex space-x-2">
                            ...
                            <span className="leading-tight">
                              Learn from competitors about what to do, and not
                              to do
                            </span>
                          </li>
                          <li className="flex space-x-2">
